...
Initials: AKS
Date: 23-10-25
Project: GestureAI (Web/Demo Version)
"""
import cv2
...
def handle_gesture(gesture):
    """Print the recognized gesture to console"""
...
print("🎥 Starting AI gesture demo. Press ESC to exit.")
...
while cap.isOpened():
    ...
    cv2.imshow("GestureAI Demo", frame)
